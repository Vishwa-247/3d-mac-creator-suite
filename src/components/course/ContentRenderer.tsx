    ...
    <div className="max-w-none leading-relaxed space-y-4 text-foreground">
      <ReactMarkdown
        ...
        components={{
          ...
          h1({ children }) {
            return <h1 className="text-3xl font-serif font-bold mt-8 mb-4">{children}</h1>;
          },
          h2({ children }) {
            return <h2 className="text-2xl font-serif font-bold mt-6 mb-3">{children}</h2>;
          },
          h3({ children }) {
            return <h3 className="text-xl font-serif font-semibold mt-4 mb-2">{children}</h3>;
          },
          p({ children }) {
